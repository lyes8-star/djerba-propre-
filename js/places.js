...
const Places = (() => {
  ...
  const TOWN = [
    ...
    ...shopRow("houmt", -960, 0, ["Boutique", "Harissa", "The", "Brik", "Eau", "Epices"]),
    ...shopRow("houmt", -960, 176, ["Tapis", "Etal", "Etal", "Poisson", "Eau", "Harissa"]),
    shop("houmt", -1040, 88, "Marché eau", true),
    ...block("midoun", -160, 96, 5, 4, "Maison Midoun"),
    ...shopRow("midoun", -160, -80, ["Marche eau", "Etal", "Harissa", "The", "Epices"]),
    shop("midoun", 80, -96, "Citerne eau", true),
    ...block("ajim", 160, 0, 4, 4, "Maison Ajim"),
    shop("ajim", -200, 0, "Poisson"), shop("ajim", -200, 176, "Etal", true),
    shop("ajim", -280, 88, "Eau port", true),
